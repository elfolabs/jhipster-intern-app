...
describe('MediaFile Management Component', () => {
  let comp: MediaFileComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MediaFileComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mediaFiles[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
