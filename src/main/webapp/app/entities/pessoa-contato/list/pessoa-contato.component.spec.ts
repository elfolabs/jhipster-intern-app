...
describe('PessoaContato Management Component', () => {
  let comp: PessoaContatoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PessoaContatoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pessoaContatoes[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
